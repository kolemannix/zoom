 ...
 * Created On 4/16/13
 */
public class ExistentialNode extends AbstractASTNode{

    private ASTNode child;
    private Variable variable;

    public ExistentialNode(Variable variable, ASTNode child) {
    ...
    @Override
    public String print() {
        return "There exists a " + variable.getSymbol() + " such that " + child.print();
    }
